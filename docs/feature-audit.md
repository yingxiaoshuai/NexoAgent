...
- Knowledge retrieval is keyword-based, not vector indexed or graph-based.
...
- Upgrade knowledge retrieval to hybrid keyword/vector search and add automatic curation.
